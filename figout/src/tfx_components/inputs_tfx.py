...
from tfx_components.periphery_builders import _get_augmenter
...
def preprocessing_fn(inputs):
  ...
  """
    outputs = {}
    augmenter = _get_augmenter(inputs.custom_config.get('augmenter'))
    outputs[transformed_name('image')] = inputs[transformed_name('image')].map(augmenter.distort)
